      ...
      <>
        ...
        <p className="text-left col-10 mx-auto">This will vary, depending on what your therapeutic goals are and what treatment approach your therapist employs. In general, here are some of the things you can expect to happen during appointments:</p>
          <ol className="list-group list-group-numbered">
            ...
            <li className="col-10 mx-auto list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">Your therapist may introduce or review information that is relevant to the achievement of your therapeutic goals. This information could relate to a particular diagnosis, to common factors that contribute to a specific problem or experience, information about a specific treatment approach that could be beneficial, and strategies to implement that could help you make progress toward your therapeutic goals.</div>
            </li>
            <li className="col-10 mx-auto list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">Your therapist may guide you through specific exercises that could be helpful to you.</div>
            </li>
            <li className="col-10 mx-auto list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">You and your therapist may review and build upon exercises you were given to do outside of your appointment. While a lot of progress can be made in your therapy appointments, the bulk of your therapeutic progress will be based on the work you do outside of therapy. A major goal of therapy is to further empower you to effectively navigate the challenges that come up in life.</div>
            </li>
