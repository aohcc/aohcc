...
export default function Footer() {
  ...
  <>
    <footer className="footer-color d-flex flex-column justify-content-center p-3">
        ...
        <p className="text-center text-light">Photo by <a href="https://unsplash.com/@pioneermedia?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Leighton Smith</a> on <a href="https://unsplash.com/photos/NPxkSK-makg?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
  </p>
    </footer>
  </>
  )
